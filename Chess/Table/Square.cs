...
namespace Chess.Model
{
    ...
    {//
        ...
        public static char[] Ranks = { '8', '7', '6', '5', '4', '3', '2', '1' };//цифры
        public static char[] Files = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h' };//буквы
        ...
        /*
        override изменяет или расширяет реализацию унаследованного метода, свойства,
        индексатора или события.
        */
